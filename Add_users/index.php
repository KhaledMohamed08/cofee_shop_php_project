...
<body style="background-color:#3e2317;">
<div class="container" >
	<div style="height:50px;"></div>
	<div class="well" style="margin:auto; padding:auto; width:80%;">
	<span style="font-size:25px; color:blue"><center><strong style="color:#b68734;">ALL USERS</strong></center></span>	
		<span class="pull-left"><a href="#addnew" data-toggle="modal" class="btn btn-primary" style="background-color:#3e2317;"><span class="glyphicon glyphicon-plus"></span > Add New</a></span>
		<div style="height:50px;"></div>
