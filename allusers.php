    ...
    <table>
        ...
        <?php foreach ($users as $value) : ?>
            <tr>
                ...
                <td><img src="./images/ ?php echo $value['image']  ?>" width="100px" height="100px" alt=""></td>
                <td>
                  <a class="btn btn-warning" href="./edituser.php>" class="btn btn-warning"><i class="fas fa-sloid fa-marker"> </i></a>
                  <a class="btn btn-danger" href="./deleteuser.php" class="btn btn-danger"> <i class="far fa-trash-alt"></i></a>
              </td>
            </tr>
        <?php endforeach; ?>
    </table>
